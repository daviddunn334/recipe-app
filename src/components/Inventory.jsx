      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center mb-4">
            <FaBoxOpen className="text-indigo-600 text-xl mr-2" />
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center mb-4">
            <FaSearch className="text-indigo-600 text-xl mr-2" />
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center mb-4">
            <FaFilter className="text-indigo-600 text-xl mr-2" />
          ...
          <div className="space-y-4">
            {categories.slice(0, 5).map(category => {
              ...
              return (
                <div key={category} className="flex justify-between items-center p-3 bg-gray-100 rounded-lg">
                  <div>
                    <div className="font-medium">{category}</div>
                    <div className="text-sm text-gray-600">{categoryItems.length} unique items</div>
                  </div>
