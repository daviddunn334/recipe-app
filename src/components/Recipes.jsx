...
function Recipes() {
  ...
  const handleAddRecipe = async () => {
    try {
      ...
      const imageUrl =
        newRecipe.image_url || "https://placehold.co/600x400?text=No+Image";
      ...
      <div key={recipe.id} className="card bg-base-100 shadow-xl">
        <figure className="relative h-48">
          ...
          <div className="absolute top-2 right-2 flex gap-2">
            ...
            <div
              className={`badge ${
                mealTypeColors[recipe.type] || "bg-base-300"
              }`}
            >
              {recipe.type}
            </div>
        ...
        <div className="card-body">
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            <div className="badge badge-outline">{recipe.difficulty}</div>
            <div className="badge badge-outline">{recipe.mode_of_prep}</div>
